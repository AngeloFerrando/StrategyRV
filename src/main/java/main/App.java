...
//        FileWriter fw = new FileWriter(file);
        ...
        for(double percImperfect = 0.0; percImperfect <= 1; percImperfect+=0.1) {
            ...
            for (int i = 0; i < nRuns; i++) {
                ...
                List<RVItem> res = isSatisfiedWithPerfectInformation(m, actions);
                stopwatch.stop();
...
//    private static Automaton.Outcome isSatisfiedWithPerfectInformation1(AtlModel atlModel, List<Set<String>> h) throws IOException {
...
//                Automaton.Outcome k = verification(atlModel, result, h);
...
//    }
    ...
    public static List<RVItem> isSatisfiedWithPerfectInformation(AtlModel atlModel, List<List<AgentAction>> actions) throws IOException {
